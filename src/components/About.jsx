        ...
        <div className="grid md:grid-cols-5 gap-10 items-start">
          ...
          >
            <div className="glass rounded-2xl p-8 card-hover">
              <h3 className="text-xl font-semibold text-text-primary mb-4 flex items-center gap-3">
                <span className="w-10 h-10 rounded-lg bg-primary/10 border border-primary/20 flex items-center justify-center text-lg">
                  👨‍💻
                </span>
                ¿Quién soy?
              </h3>
          ...
          >
            {stats.map((stat, i) => (
              <div
                key={stat.label}
                className="glass rounded-2xl p-6 text-center card-hover hover:border-primary/25 transition-all duration-300"
                style={{ animationDelay: `${i * 100}ms` }}
              >
                <div className="text-3xl font-bold gradient-text mb-1 font-mono-accent">
                  {stat.value}
                </div>
