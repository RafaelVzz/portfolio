  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
        ...
        <a
          href="#inicio"
          className="font-mono-accent text-lg font-bold tracking-tight hover:opacity-80 transition-opacity"
        >
        ...
        <ul className="hidden md:flex items-center gap-1">
          ...
          <li className="ml-3">
            <a
              ...
              className="flex items-center gap-2 px-4 py-2 rounded-lg border border-primary/25 text-primary hover:bg-primary/10 transition-all duration-300 text-sm font-medium font-mono-accent"
            >
